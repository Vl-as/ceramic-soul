...
try {
  const valid = new JustValidate(".footer__form");
  valid
    .addField(
      "#footer-email",
      [
      ...
      ],
      {
        errorsContainer: document
          ...
          .parentElement.querySelector(".error-message-f-email"),
      }
    )
    .addField(
      "#footer-checkbox",
